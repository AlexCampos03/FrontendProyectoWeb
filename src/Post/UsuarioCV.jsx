...
const PaginaRegistro = () => {
  ...
  useEffect(() => {
    const obtenerDatos = async () => {
      try {
        const respuesta = await axios.get("https://silly-slippers-toad.cyclic.app/api/auth/whoami", {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const respuesta = await axios.patch(`https://silly-slippers-toad.cyclic.app/api/auth/edit-user-profile/${id}`, datosFormulario, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`
        }
      })
