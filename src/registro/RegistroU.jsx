...
const PaginaRegistro = () => {
    ...
    const [datosFormulario, setDatosFormulario] = useState({
        ...
        confirmacion: '',
        telephone: '',
        fotoPerfil: null, // Se añade el campo para la foto de perfil
    });
    ...
    const handleChange = (e) => {
        if (e.target.name === 'birthDate') {
            ...
            setDatosFormulario({ ...datosFormulario, [e.target.name]: formattedDate });
        } else {
    ...
    const handleSubmit = async (e) => {
        ...
        let response = null;
        try {
            response = await axios.post('https://silly-slippers-toad.cyclic.app/api/auth/register-user', JSON.stringify(datosFormulario), {
                headers: {
